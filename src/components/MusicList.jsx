...
const MusicList = ({ selectedData, musicList, selectMusic }) => {
  return (
    <div className="overflow-hidden overflow-x-scroll mt-5 mb-5">
      {selectedData && (
        <div className="py-4 min-w-fit flex flex-row overflow-hidden space-x-4 ">
          <div className="w-12 h-12 border-2 border-neutral-400 rounded-full grid place-items-center">
